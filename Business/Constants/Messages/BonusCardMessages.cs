...
namespace Business.Constants.Messages
{
    public static class BonusCardMessages
    {
        ...
        public static string ThisBarcodeAlreadyExistsABonusCard = "Bu barkod artıq başqa bonus kartda qeyd edilib";
        ...
        public static string BarcodeNumberEqualSettingValue(int length) => $"Barkod sayı {length}'ə bərabər olmalıdır!";
    }
}
