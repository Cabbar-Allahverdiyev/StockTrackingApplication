...
{
    public static class FormsTextMessages
    {
        public static string PasswordOrEmailIsBlank = "Email və ya şifrə boşdur";
        ...
        public static string IdBlank = "'Id' bölməsi boşdur zəhmət olmasa bir dəyər seçin";
