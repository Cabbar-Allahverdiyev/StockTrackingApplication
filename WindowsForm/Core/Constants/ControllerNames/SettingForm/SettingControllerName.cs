...
namespace WindowsForm.Core.Constants.ControllerNames.SettingForm
{
    public static class SettingControllerName
    {
        ...
        public static string TextBoxSignsDecimalPoint = "textBoxSignsDecimalPoint";
