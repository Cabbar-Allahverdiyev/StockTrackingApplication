...
namespace WindowsForm.BonusCardSystem.Forms.AdminForms
{
    public partial class BonusCardAdminDashboard : Form
    {
        ...
        {
            OpenChildForm(new WindowsForm.Forms.USBBarcodeScannerForm(_barcodeGenerator
        ...
        private void bonusKartYeniləVəSilToolStripMenuItem_Click(object sender, EventArgs e)
        {
