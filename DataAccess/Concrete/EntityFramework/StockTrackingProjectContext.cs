...
{           
    public class StockTrackingProjectContext : DbContext,IStockTrackingDbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //optionsBuilder.UseSqlServer(@"Server=DESKTOP-RPJIB7U\SQLEXPRESS;Database=StockTracking;Trusted_Connection=true"); //Asim Kassa Tel yeni
            // optionsBuilder.UseSqlServer(@"Server=DESKTOP-0019BBJ\SQLEXPRESS;Database=StockTracking;Trusted_Connection=true"); //Asim Kassa Tel yeni
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-3K1ILI5\SQLEXPRESS;Database=StockTracking;Trusted_Connection=true"); //Saleh 
        }
